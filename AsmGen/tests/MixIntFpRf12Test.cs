...
namespace AsmGen
{
    public class MixIntFp12RfTest : UarchTest
    {
        public MixIntFp12RfTest(int low, int high, int step)
        {
            this.Counts = UarchTestHelpers.GenerateCountArray(low, high, step);
            this.Prefix = "mixintfp12rf";
            this.Description = "Mix of integer and FP register file, 1:2 ratio";
        ...
        public override void GenerateX86GccAsm(StringBuilder sb)
        {
            ...
            string[] instrs = new string[6];
            instrs[0] = "add %r15, %r14";
            instrs[1] = "addss %xmm1, %xmm2";
            instrs[2] = "addss %xmm1, %xmm3";
            instrs[3] = "add %r15, %r12";
            instrs[4] = "addss %xmm1, %xmm4";
            instrs[5] = "addss %xmm1, %xmm5";
        ...
        public override void GenerateX86NasmAsm(StringBuilder sb)
        {
            ...
            instrs[3] = "add r12, r15";
            instrs[4] = "addss xmm4, xmm1";
            instrs[5] = "addss xmm5, xmm1";
        ...
        public override void GenerateArmAsm(StringBuilder sb)
        {
            ...
            instrs[3] = "  add x13, x13, x11";
            instrs[4] = "  fadd s20, s20, s17";
            instrs[5] = "  fadd s21, s21, s17";
