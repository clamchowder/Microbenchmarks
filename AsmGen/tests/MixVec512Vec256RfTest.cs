...
namespace AsmGen
{
    public class MixVec512Vec256RfTest : UarchTest
    {
        public MixVec512Vec256RfTest(int low, int high, int step)
        {
            ...
            this.Description = "Mixed Vector (512-bit packed fp, 256-bit packed fp) RF Test - x86 only";
        ...
        public override void GenerateX86GccAsm(StringBuilder sb)
        {
            ...
            unrolledAdds[1] = "  vaddps %ymm3, %ymm3, %ymm0";
            unrolledAdds[2] = "  vaddps %zmm1, %zmm4, %zmm4";
            unrolledAdds[3] = "  vaddps %ymm3, %ymm3, %ymm6";
        ...
        public override void GenerateX86NasmAsm(StringBuilder sb)
        {
            ...
            unrolledAdds[1] = "  vaddps ymm0, ymm3, ymm0";
            unrolledAdds[2] = "  vaddps zmm4, zmm4, zmm1";
            unrolledAdds[3] = "  vaddps ymm0, ymm5, ymm0";
