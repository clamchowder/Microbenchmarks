...
namespace AsmGen
{
    public class MixRorBtsSchedTest : UarchTest
    {
        public MixRorBtsSchedTest(int low, int high, int step)
        {
            this.Counts = UarchTestHelpers.GenerateCountArray(low, high, step);
            this.Prefix = "mixrorbtssched";
            this.Description = "Mixed BTS/ROR Scheduler Capacity Test";
        ...
        public override void GenerateX86GccAsm(StringBuilder sb)
        {
            ...
            instrs1[0] = "  ror $1, %r15";
            instrs1[1] = "  bts %rdi, %r12";
            string[] instrs2 = new string[2];
            instrs2[0] = "  ror $1, %r15";
            instrs2[1] = "  bts %rsi, %r11";
        ...
        public override void GenerateX86NasmAsm(StringBuilder sb)
        {
            ...
            instrs[0] = "  ror r15, 1";
            instrs[1] = "  bts r12d, edi";
            string[] instrs1 = new string[2];
            instrs1[0] = "  ror r15, 1";
            instrs1[1] = "  bts r11d, esi";
