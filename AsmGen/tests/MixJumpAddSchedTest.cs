...
namespace AsmGen
{
    public class MixJmpAddSched : UarchTest
    {
        public MixJmpAddSched(int low, int high, int step)
        {
            this.Counts = UarchTestHelpers.GenerateCountArray(low, high, step);
            this.Prefix = "mixjmpaddsched";
        ...
        public override void GenerateArmAsm(StringBuilder sb)
        {
            ...
            unrolledJumps[0] = "  add w14, w13, w25";
            unrolledJumps[1] = "  cbz w14, jumpsched_reallybadthing_jadd";
