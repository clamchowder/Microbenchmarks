...
namespace AsmGen
{
    public class MixPdepMulSchedTest : UarchTest
    {
        public MixPdepMulSchedTest(int low, int high, int step)
        {
            this.Counts = UarchTestHelpers.GenerateCountArray(low, high, step);
            this.Prefix = "mixpdepmulsched";
            this.Description = "Mixed Multiply/PDEP Scheduler Capacity Test";
